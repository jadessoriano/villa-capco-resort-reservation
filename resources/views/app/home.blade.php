        ...
        <div class="w-full xl:w-1/2 xl:pl-40 xl:py-28">
            ...
            <div class="mt-12">
                <form action="{{ route('newsletter.subscribe') }}" method="POST" class="flex items-stretch">
                    @csrf
                    <input name="email" class="bg-gray-300 rounded-lg rounded-r-none text-base leading-none text-gray-800 p-5 w-4/5 border border-transparent focus:outline-none focus:border-gray-500" type="email" placeholder="Your Email" required/>
