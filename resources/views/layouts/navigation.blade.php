<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('accommodations')" :active="request()->routeIs('accommodations')">
                        {{ __('Accommodations') }}
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('caterings')" :active="request()->routeIs('caterings')">
                        {{ __('Caterings') }}
                    </x-nav-link>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    <!-- Settings Dropdown -->
                    <x-dropdown align="right" width="48" :contentClasses="'bg-primary-bg'">
                        <x-slot name="trigger">
                ...
                @else
                    ...
                    <div class="ml-3">
                        <x-nav-link :href="route('register')">{{ __('Sign Up') }}</x-nav-link>
                    </div>
                @endauth
            </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-primary-fg focus:outline-none focus:bg-secondary-fg focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('accommodations')" :active="request()->routeIs('accommodations')">
                {{ __('Accommodations') }}
            </x-responsive-nav-link>
        </div>
